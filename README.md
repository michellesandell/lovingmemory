...
Now, any time you make a change to the code and push the change, GitHub actions `should` pick up the change and run a workflow, `.github/workflows/cd.yml`, that generates the static files, and fixes image names.